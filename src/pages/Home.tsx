  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonModal ref={modal} trigger="open-modal" initialBreakpoint={0.75} breakpoints={[0, 0.75]} className="h-full qrmodal" handleBehavior="cycle">
          <IonHeader>
            <IonToolbar className="">
              ...
              <IonTitle>QRCODE SCANNER</IonTitle>
            </IonToolbar>
          </IonHeader>
