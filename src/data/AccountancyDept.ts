...
const AccountancyDept = {
    ...
    // ACADEMIC BUILDING
    Clinic: {image: AccountancyToClinic, floorLevel: "1", buildingName: "Admin", roomName: "Medical and Dental Clinic"},
    CPCE: {image: AccountancyToCPCE, floorLevel: "1", buildingName: "Admin", roomName: "Center for Preofessional and Continuing Education"},
    Library: {image: AccountancyToLibrary, floorLevel: "1", buildingName: "Admin", roomName: "Library"},
    // ACADEMIC BUILDING
